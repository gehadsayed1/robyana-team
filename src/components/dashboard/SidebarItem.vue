...
<template>
  <router-link
    ...
    :class="isActive
      ? 'bg-blue-100 text-sm text-blue-600 border-l-4 border-blue-600'
...
import * as lucideIcons from 'lucide-vue-next' // تأكد أنك مثبت الحزمة: npm i lucide-vue-next

const props = defineProps({
  to: { type: [String, Object], required: true },
  icon: { type: String, required: true }, // اسم الأيقونة مثل "Home" أو "Users"
