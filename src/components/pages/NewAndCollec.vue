<template>
  <div class="flex flex-col md:flex-row gap-4 mt-10 items-center justify-center py-4">
...
<script setup>
import image1 from '@/assets/best-sellar.jpg'
import image2 from '@/assets/new-collection.jpg'
